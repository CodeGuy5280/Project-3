...
import profile from "assets/img/yoga.png";
              ...
              <GridItem xs={12} sm={12} md={6}>
                <div className={classes.profile}>
                  ...
                  <div className={classes.name}>
                    <h3 className={classes.title}>Yoga Practices</h3>
                    <h6>Relax</h6>
                  </div>
                </div>
              </GridItem>
                  ...
                  tabs={[
                      ...
                      tabContent: (
                        <GridContainer justify="center">
                          <GridItem xs={12} sm={12} md={12}>
                            ...
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/4pKly2JojMw" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen title="yogab10"></iframe>
                    ...
                    },
                    {
                      ...
                      tabContent: (
                        <GridContainer justify="center">
                          ...
                          <iframe width="560" height="315" src="https://www.youtube.com/embed/oar85e9GdLw" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen title="yogai10"></iframe>
                    ...
                    },
                    {
                      ...
                      tabContent: (
                        <GridContainer justify="center">
                          <GridItem xs={12} sm={12} md={4}>
                          <iframe width="560" height="315" src="https://www.youtube.com/embed/msgu-gz4oww" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen title="yogai5"></iframe>
                          <iframe width="560" height="315" src="https://www.youtube.com/embed/bGI-issML4c" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen title="yogaa10"></iframe>
